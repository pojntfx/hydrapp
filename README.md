...
![Screenshot of the GitHub pages source setting](./docs/screenshot-enable-github-pages.png)
...
![Screenshot of the GitHub actions secret add wizard](./docs/screenshot-add-actions-secret.png)

Once you've added all of them, they should look like this:

![Screenshot of the GitHub actions secret list](./docs/screenshot-show-actions-secrets.png)
