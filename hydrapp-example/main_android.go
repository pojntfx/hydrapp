...
//export Java_com_pojtinger_felix_hydrappexample_MainActivity_LaunchBackend
func Java_com_pojtinger_felix_hydrappexample_MainActivity_LaunchBackend(env *C.JNIEnv, activity C.jobject) C.jstring {
