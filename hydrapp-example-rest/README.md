## Hydrapp REST Example

Hydrapp REST example app.
...
A simple Hydrapp REST example app.
...
To build and start a development version of Hydrapp REST Example locally, run the following:
...
Hydrapp REST Example (c) 2023 Felicitas Pojtinger and contributors
