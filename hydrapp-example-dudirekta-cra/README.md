## Hydrapp Dudirekta-CRA Example

Hydrapp Dudirekta and Create React App example app.
...
A simple Hydrapp Dudirekta and Create React App example app.

## Installation

See [INSTALLATION.html](https://pojntfx.github.io/hydrapp/hydrapp-example-dudirekta-cra//docs/main/INSTALLATION.html).
...
To build and start a development version of Hydrapp Dudirekta-CRA Example locally, run the following:

```shell
$ git clone https://github.com/pojntfx/hydrapp.git
$ cd hydrapp-example-dudirekta-cra
$ go generate ./...
$ go run .
```
