...
import (
	...
	backend "github.com/pojntfx/hydrapp/hydrapp-example-dudirekta-cra/pkg/backend"
	frontend "github.com/pojntfx/hydrapp/hydrapp-example-dudirekta-cra/pkg/frontend"
)

//export Java_com_pojtinger_felicitas_hydrapp_example_dudirekta_cra_MainActivity_LaunchBackend
func Java_com_pojtinger_felicitas_hydrapp_example_dudirekta_cra_MainActivity_LaunchBackend(env *C.JNIEnv, activity C.jobject) C.jstring {
