...
//export Java_com_pojtinger_felix_hydrapp_example_MainActivity_LaunchBackend
func Java_com_pojtinger_felix_hydrapp_example_MainActivity_LaunchBackend(env *C.JNIEnv, activity C.jobject) C.jstring {
